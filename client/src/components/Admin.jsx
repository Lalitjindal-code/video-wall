...
export default function Admin() {
    ...
    const [matrix, setMatrix] = useState({ rows: 10, cols: 10, eventName: "Paradox", users: {} });
    ...
    const totalConnected = Object.keys(matrix.users).length;
                ...
                <section className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        <div className="bg-zinc-900 p-6 rounded-2xl border border-zinc-800">
                            ...
                            <h2 className="text-lg font-bold mb-4 text-[#00f0ff]">Upload Video Source</h2>
                            <p className="text-xs text-zinc-400 mb-4">Upload a new MP4. This will reset the wall and force all clients to reload the new video.</p>
                            ...
                            >
                                ...
                                <span className="relative z-10 flex items-center gap-2">
                                    ...
                                    {isUploading ? `Uploading ${Math.round(uploadProgress)}%` : 'Upload Video to Cloud'}
                                </span>
                            </button>
                    ...
                    <div className="lg:col-span-8 space-y-6">
                        ...
                        <div className="bg-zinc-900 p-6 rounded-2xl border border-zinc-800 shadow-[0_0_50px_rgba(0,0,0,0.3)]">
                            <h2 className="text-xl font-bold mb-4 text-[#00f0ff]">Video Preview</h2>
                            <div className="w-full aspect-video bg-black rounded-xl overflow-hidden shadow-inner flex items-center justify-center relative">
                                {matrix.videoUrl ? (
                                    ...
                                    <p className="text-zinc-600 font-bold uppercase tracking-widest text-sm">No Video Loaded</p>
                                )}
                            </div>
                        </div>
